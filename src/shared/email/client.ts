 ...
 * throws into a webhook handler. Stripe and Mux retry on any non-2xx, so a
 * throwing send would turn a degraded email provider into a retry storm against
 * a payment that already succeeded. See ADR 004.
 *
