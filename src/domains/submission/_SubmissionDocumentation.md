...
| **6 · Translated** | Hand to the coach | `③ hand-off → coach failed`<br>`③ hand-off → coach bounced — hard`<br>`③ hand-off → coach bounced — soft`<br>`③ hand-off → coach bounced`<br>`③ hand-off → coach complained` | **Admin** ▣ “This has already gone to a coach. Reload to see where it is.” *(not built)* | `③ hand-off → coach`<br>`③ hand-off → coach delivered` | **Admin** ▣ the row moves to Sent | Handed to the coach |
...
| **8 · Reviewing** | Upload the response | — | **Coach** ▣ “That file was rejected — too large, wrong type, or empty.” *(not built)* | — | **Coach** ▣ the file appears in their folder | Response uploaded |
