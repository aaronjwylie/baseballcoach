...
| [018](018-translator-role.md) | The translator role: `operator` absorbs `coach`, assignment becomes a join | ⚠️ **Proposed — not built.** Three open questions to settle first |
