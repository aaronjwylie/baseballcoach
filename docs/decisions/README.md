...
| [018](018-translator-role.md) | The translator role: `operator` + `operatorProfile`, assignment becomes a join | **Phases 1–2 built.** Phase 3 designed, waits on the `response`→`feedback` rename |
